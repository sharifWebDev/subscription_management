    ...
    <div class="row">
        ...
        <div class="mb-3 col-12 col-md-4 col-lg-3">
            <div class="form-group">
                ...
                <input type="text" name="code" class="form-control @error('code') is-invalid @enderror"
                    value="{{ old('code') }}" placeholder="Enter Code..." id="create_code" required>
                @error('code')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="mb-3 col-12 col-md-4 col-lg-3">
            <div class="form-group">
                ...
                <textarea name="description" class="form-control @error('description') is-invalid @enderror"
                    placeholder="Enter Description..." id="create_description" required>{{ old('description') }}</textarea>
                @error('description')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="mb-3 col-12 col-md-4 col-lg-3">
            <div class="form-group">
                ...
                <input type="text" name="type" class="form-control @error('type') is-invalid @enderror"
                    value="{{ old('type') }}" placeholder="Enter Type..." id="create_type" required>
                @error('type')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="mb-3 col-12 col-md-4 col-lg-3">
            <div class="form-group">
                ...
                <input type="text" name="billing_period"
                    ...
                    value="{{ old('billing_period') }}" placeholder="Enter Billing Period..." id="create_billing_period"
                    required>
        ...
        <div class="mb-3 col-12 col-md-4 col-lg-3">
            <div class="form-group">
                ...
                <input type="number" name="billing_interval" min="0"
                    class="form-control @error('billing_interval') is-invalid @enderror"
                    value="{{ old('billing_interval') }}" placeholder="Enter Billing Interval..."
                    id="create_billing_interval" required>
        ...
        <div class="mb-3 col-12 col-md-4 col-lg-3">
            <div class="form-group">
                ...
                <input type="radio" name="is_visible" id="create_is_visible_yes" value="1"
                    {{ old('is_visible') == 1 ? 'checked' : '' }} checked>
                <label for="create_is_visible_yes">Is Visible Yes</label>
                <input type="radio" name="is_visible" id="create_is_visible_no" value="0"
        ...
        <div class="mb-3 col-12 col-md-4 col-lg-3">
            <div class="form-group">
                ...
                <input type="number" name="sort_order" min="0"
                    ...
                    placeholder="Enter Sort Order..." id="create_sort_order" required>
                @error('sort_order')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="mb-3 col-12 col-md-4 col-lg-3">
            <div class="form-group">
                ...
                <input type="radio" name="is_featured" id="create_is_featured_yes" value="1"
                    {{ old('is_featured') == 1 ? 'checked' : '' }} checked>
                <label for="create_is_featured_yes">Is Featured Yes</label>
                <input type="radio" name="is_featured" id="create_is_featured_no" value="0"
        ...
        <div class="mb-3 col-12 col-md-4 col-lg-3">
            <div class="form-group">
                ...
                <input type="text" name="metadata" class="form-control @error('metadata') is-invalid @enderror"
                    value="{{ old('metadata') }}" placeholder="Enter Metadata..." id="create_metadata" required>
                @error('metadata')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
