            ...
            <form method="POST" id="editplansForm" action="{{ url('api/v1/plans/update/' . request()->id ?? "") }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                ...
                <div class="mb-3 col-12 col-md-4 col-lg-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="billing_period" class="form-control @error('billing_period') is-invalid @enderror" value="{{ old('billing_period', $query->billing_period ?? "") }}" placeholder="Enter Billing Period..." id="edit_billing_period" required>
                ...
                <div class="mb-3 col-12 col-md-4 col-lg-3">
                    <div class="form-group">
                        <label for="billing_interval">Billing Interval</label><br>
                        <input type="number" name="billing_interval" min="0" class="form-control @error('billing_interval') is-invalid @enderror" value="{{ old('billing_interval', $query->billing_interval ?? "") }}" placeholder="Enter Billing Interval..." id="edit_billing_interval" required>
                ...
                <div class="mb-3 col-12 col-md-4 col-lg-3">
                    <div class="form-group">
                        <label for="is_visible">Is Visible</label><br>
                                ...
                                <input type="radio" name="is_visible" id="edit_is_visible_yes" value="1" {{ old('is_visible', $query->is_visible ?? "") == 1 ? "checked" : "" }} checked>
                                <label for="editis_visible_yes">Is Visible Yes</label>
                                <input type="radio" name="is_visible" id="edit_is_visible_no" value="0" {{ old('is_visible', $query->is_visible ?? "") == 0 ? "checked" : "" }}>
                                <label for="editis_visible_no">Is Visible No</label>
                        @error('is_visible')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mb-3 col-12 col-md-4 col-lg-3">
                    <div class="form-group">
                        <label for="is_featured">Is Featured</label><br>
                                ...
                                <input type="radio" name="is_featured" id="edit_is_featured_yes" value="1" {{ old('is_featured', $query->is_featured ?? "") == 1 ? "checked" : "" }} checked>
                                <label for="editis_featured_yes">Is Featured Yes</label>
                                <input type="radio" name="is_featured" id="edit_is_featured_no" value="0" {{ old('is_featured', $query->is_featured ?? "") == 0 ? "checked" : "" }}>
                                <label for="editis_featured_no">Is Featured No</label>
                        @error('is_featured')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
