                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="payment-type-card">
                                        <input type="radio" class="btn-check" name="payment_type" id="type_card"
                                ...
                                <div class="col-md-6">
                                    <div class="payment-type-card">
                                        <input type="radio" class="btn-check" name="payment_type" id="type_bank"
                                            value="bank_account" autocomplete="off">
