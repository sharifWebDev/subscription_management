...
<script>
    $(document).ready(function() {
            ...
            axios.get(`/subscriptions/${id}`)
                .then(response => {
                    ...
                    const billingPeriod = sub.plan_id_details ?
                        `${sub.plan_id_details.billing_period} (x${sub.plan_id_details.billing_interval})` : 'N/A';
        ...
        $('#cancelForm').submit(function(e) {
            ...
            $('#cancelSubmitBtn').prop('disabled', true).html('<span class="spinner-border spinner-border-sm me-2"></span>Cancelling...');
            ...
            .finally(() => {
                $('#cancelSubmitBtn').prop('disabled', false).html('<i class="fas fa-ban me-2"></i>Cancel Subscription');
            });
        });
        ...
        $('#refundForm').submit(function(e) {
            ...
            $('#refundSubmitBtn').prop('disabled', true).html('<span class="spinner-border spinner-border-sm me-2"></span>Processing...');
            ...
            .finally(() => {
                $('#refundSubmitBtn').prop('disabled', false).html('<i class="fas fa-undo-alt me-2"></i>Request Refund');
            });
        });
                ...
                if (result.isConfirmed) {
                    axios.post(`/subscriptions/${id}/renew`)
                        ...
                        .catch(error => {
                            ...
                            toastr.error(error.response?.data?.message || 'Failed to renew subscription');
                        });
                }
            });
        };
