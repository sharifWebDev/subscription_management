                ...
                <form id="profileForm" enctype="multipart/form-data">
                    ...
                    <div class="mb-4 text-center">
                        <div class="position-relative d-inline-block">
                            <img src="{{ auth()->user()->avatar ?? 'https://via.placeholder.com/120' }}" id="profilePreview"
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="country" name="country">
                                ...
                                <option value="US"
                                    {{ (auth()->user()->billing_address->country ?? '') == 'US' ? 'selected' : '' }}>United
                                    States</option>
                                <option value="GB"
                                    {{ (auth()->user()->billing_address->country ?? '') == 'GB' ? 'selected' : '' }}>United
                                    Kingdom</option>
                                <option value="CA"
                                    {{ (auth()->user()->billing_address->country ?? '') == 'CA' ? 'selected' : '' }}>Canada
                                </option>
                                <option value="AU"
                                    {{ (auth()->user()->billing_address->country ?? '') == 'AU' ? 'selected' : '' }}>
                                    Australia</option>
                                <option value="BD"
                                    {{ (auth()->user()->billing_address->country ?? '') == 'BD' ? 'selected' : '' }}>
                                    Bangladesh</option>
                                <option value="IN"
                                    {{ (auth()->user()->billing_address->country ?? '') == 'IN' ? 'selected' : '' }}>India
                                </option>
                            </select>
                        </div>
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="billing_type" name="billing_type">
                                <option value="personal"
                                    {{ auth()->user()->billing_type == 'personal' ? 'selected' : '' }}>Personal</option>
                                <option value="business"
                                    {{ auth()->user()->billing_type == 'business' ? 'selected' : '' }}>Business</option>
                                <option value="enterprise"
                                    {{ auth()->user()->billing_type == 'enterprise' ? 'selected' : '' }}>Enterprise
                                </option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div id="businessInfo"
                        style="display: {{ auth()->user()->billing_type == 'personal' ? 'none' : 'block' }};">
                        <hr>
