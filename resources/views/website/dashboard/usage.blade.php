        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <div id="usageContent" style="display: none;">
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="month" class="form-control" id="dateSelector"
                                           value="{{ date('Y-m') }}">
                                </div>
                    ...
                    <div class="card border-0 shadow-sm mb-4 bg-gradient-primary text-white" id="currentPeriodCard" style="display: none;">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-md-8">
    ...
    $(document).ready(function() {
        ...
        function loadCurrentBilling(subscriptionId) {
            ...
            axios.get(`/current-billing`, {
                params: { subscription_id: parseInt(subscriptionId) }
            })
            .then(response => {
                const data = response.data.data;
        ...
        function renderFeatureTable(features) {
            ...
            if (!features || features.length === 0) {
                ...
                features.forEach(feature => {
                    ...
                    const progressClass = percentage > 80 ? 'bg-danger' : (percentage > 60 ? 'bg-warning' : 'bg-success');
        ...
        function updateChart(chartData) {
            ...
            usageChart = new Chart(ctx, {
                ...
                data: {
                    labels: labels,
                    datasets: [{
                        label: currentChartType === 'quantity' ? 'Usage Quantity' : 'Usage Cost',
                        data: values,
