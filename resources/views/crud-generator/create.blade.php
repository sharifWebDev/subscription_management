                            ...
                            <ul class="nav nav-tabs card-header-tabs" id="usageTabs" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="subscriptions-tab" data-bs-toggle="tab"
                                        data-bs-target="#subscriptions" type="button" role="tab">Subscription
                                        Details</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="forecast-tab" data-bs-toggle="tab"
                                        data-bs-target="#forecast" type="button" role="tab">Usage Forecast</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="all-features-tab" data-bs-toggle="tab"
                                        data-bs-target="#all-features" type="button" role="tab">All
                                        Features</button>
                                </li>
                            </ul>
                        </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                function updateQuickStats(data) {
                    ...
                    if (data.has_subscription) {
                        ...
                        if (crudFeature) {
                            ...
                            html += '<p class="h4">' + crudFeature.total_usage + ' / ' + crudFeature.total_limit +
                                '</p>';
                            ...
                            if (apiFeature) {
                                html += '<p class="h5">' + apiFeature.total_usage + ' / ' + apiFeature.total_limit +
                                    '</p>';
                            }
                            html += '</div>';
                        }
                ...
                function updateSubscriptionsTab(data) {
                    ...
                    html +=
                        '<thead><tr><th>ID</th><th>Plan</th><th>Status</th><th>CRUD Usage</th><th>Remaining</th><th>Progress</th></tr></thead><tbody>';
                    ...
                    crudSubscriptions.forEach(function(sub) {
                        ...
                        html += '<td><span class="badge bg-success">' + sub.subscription_status +
                        '</span></td>';
                ...
                function updateForecastTab(data) {
                    ...
                    if (data.forecasts_by_feature && data.forecasts_by_feature.crud_generation) {
                        ...
                        if (forecast.will_exceed) {
                            html += '<span class="text-danger">⚠️ Expected to exceed limit by ' + (forecast
                                .total_projected - forecast.total_limit).toFixed(2) + '</span>';
                        }
                        html += '</div>';
                        ...
                        html +=
                            '<thead><tr><th>Subscription</th><th>Plan</th><th>Current</th><th>Daily Rate</th><th>Projected</th><th>Limit</th><th>Status</th></tr></thead><tbody>';
                ...
                function updateRecentActivityTab(data) {
                    ...
                    if (data.recent_usage && data.recent_usage.length > 0) {
                        ...
                        data.recent_usage.forEach(function(record) {
                            ...
                            html += '<small class="text-muted">Subscription #' + record.subscription_id +
                                '</small>';
                            html += '</div>';
                            html += '<div class="text-end">';
                            html += '<span class="badge bg-primary">+' + record.quantity + ' ' + record.unit +
                                '</span><br>';
                ...
                function updateAllFeaturesTab(data) {
                    ...
                    if (data.aggregated_by_feature) {
                        ...
                        html +=
                            '<thead><tr><th>Feature</th><th>Total Usage</th><th>Total Limit</th><th>Usage %</th><th>Status</th></tr></thead><tbody>';
                        ...
                        Object.values(data.aggregated_by_feature).forEach(function(feature) {
                            ...
                            html += '<td>' + (feature.is_unlimited ? 'Unlimited' : feature.total_limit) +
                                '</td>';
