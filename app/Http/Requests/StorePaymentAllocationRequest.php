...
class StorePaymentAllocationRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'payment_child_id' => ['required', 'string', 'max:255', 'exists:payment_children,id'],
            'payment_transaction_id' => ['required', 'string', 'max:255', 'exists:payment_transactions,id'],
            'allocatable_type' => ['required', 'string', 'max:255'],
            'allocatable_id' => ['required', 'string', 'max:255'],
            ...
            'is_reversed' => ['required', 'boolean', 'max:1'],
    ...
    public function messages()
    {
        return [
            ...
            'payment_child_id.required' => 'The payment child id field is required.',
            ...
            'payment_transaction_id.required' => 'The payment transaction id field is required.',
            ...
            'allocatable_type.required' => 'The allocatable type field is required.',
            ...
            'allocatable_id.required' => 'The allocatable id field is required.',
            ...
            'allocation_type.required' => 'The allocation type field is required.',
            ...
            'is_reversed.required' => 'The is reversed field is required.',
