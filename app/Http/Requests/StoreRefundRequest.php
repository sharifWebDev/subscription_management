...
class StoreRefundRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'refund_number' => ['required', 'string', 'max:255'],
    ...
    public function messages()
    {
        return [
            ...
            'refund_number.required' => 'The refund number field is required.',
            ...
            'initiated_by.required' => 'The initiated by field is required.',
            ...
            'requested_at.required' => 'The requested at field is required.',
